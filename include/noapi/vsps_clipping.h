...
std::vector<typename Shader::VariablesData> clip(const typename Shader::VariablesData data[3])
{
    ...
    case 1:
    {
        ...
        auto new_v1 = Lerper<Shader>::lerp(data[index], data[other[0]], 
                ...
                /((data[index].vPos.w + data[index].vPos.z) - (data[other[0]].vPos.w + data[other[0]].vPos.z)));
        auto new_v2 =Lerper<Shader>::lerp(data[index], data[other[1]], 
                (data[index].vPos.w + data[index].vPos.z)
                /((data[index].vPos.w + data[index].vPos.z) - (data[other[1]].vPos.w + data[other[1]].vPos.z)));
    ...
    case 2:
    {
        ...
        auto new_v1 = Lerper<Shader>::lerp(data[other[1]], data[index], 
                ...
                /((data[other[1]].vPos.w + data[other[1]].vPos.z) - (data[index].vPos.w + data[index].vPos.z)));
        auto new_v2 =Lerper<Shader>::lerp(data[other[0]], data[index], 
                (data[other[0]].vPos.w + data[other[0]].vPos.z)
                /((data[other[0]].vPos.w + data[other[0]].vPos.z) - (data[index].vPos.w + data[index].vPos.z)));
