...
#define auto_fetch(...) \
using typelist = noapi::arglist<__VA_ARGS__>;
...
namespace noapi {
    ...
    struct Fetcher<Shader, true, has_typelist> : 
            NonAutoFetcher<Shader, decltype(get_args(Shader::vertex_fetch))> {};
    template<class Shader>
    struct Fetcher<Shader, false, true> : 
            AutoFetcher<Shader, typename Shader::InputData::typelist> {};
} // namespace noapi
